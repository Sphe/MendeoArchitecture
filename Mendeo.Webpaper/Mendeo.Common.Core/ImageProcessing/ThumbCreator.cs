...
namespace Mendeo.Common.Core
{
    ...
    {
        public static void CreateThumb(Bitmap originalImage, string thumbPath, int width, int height, Brush drawBackColor, ImageFormat imageFormat)
        {
        ...
        public static void CreateThumbNoBackImage(Bitmap originalImage, string thumbPath, int width, int height, ImageFormat imageFormat)
        {
            ...
            using (var thumb = new Bitmap(intWidthTh, intHeightTh))
            {
                using (var g = Graphics.FromImage(thumb))
                {
                    ...
                    g.DrawImage(originalImage, new Rectangle(0, 0, intWidthTh, intHeightTh));
        ...
        {
            var bmp = new Bitmap(originalPath);
