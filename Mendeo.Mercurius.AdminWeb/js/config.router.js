...
.state('app.mercurius.productlist', {
    url: '/productlist',
    templateUrl: 'tpl/mercurius/productlist.html',
    controller: 'ProductListCtrl',
    resolve: {
        deps: ['$ocLazyLoad',
            function ($ocLazyLoad) {
                return $ocLazyLoad.load('kendo.directives').then(
                    function () {
                        return $ocLazyLoad.load('js/controllers/mercurius/productlist.js');
                    }
                );
            }]
    }
})
.state('app.mercurius.productedit', {
    url: '/productedit/:productId',
    templateUrl: 'tpl/mercurius/productedit.html',
    controller: 'ProductEditCtrl',
    resolve: {
        deps: ['$ocLazyLoad',
            function ($ocLazyLoad) {
                return $ocLazyLoad.load('xeditable').then(function() {
                    return $ocLazyLoad.load('js/controllers/mercurius/productedit.js');
                });
            }]
    }
})
.state('app.mercurius.attributetree', {
    url: '/attributetree',
    templateUrl: 'tpl/mercurius/attributetree.html',
    controller: 'AttributeTreeCtrl',
    resolve: {
        deps: ['$ocLazyLoad',
            function ($ocLazyLoad) {
                return $ocLazyLoad.load('angular-ui-tree').then(function () {
                    return $ocLazyLoad.load('js/controllers/mercurius/attributetree.js');
                });
            }]
    }
})
